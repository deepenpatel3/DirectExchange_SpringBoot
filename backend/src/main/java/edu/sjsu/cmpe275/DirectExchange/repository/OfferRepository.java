...
public interface OfferRepository extends JpaRepository<Offer, Long> {
    ...
    List<Offer> findExactMatchingOffer(@Param("id") long id,@Param("matchingAmount") float matchingAmount,@Param("sourceCountry") String sourceCountry, @Param("destinationCountry") String destinationCountry);
    
    @Query(value = "Select * from Offer Where user_id != :id and status = 'open' and counter_offer_or_not = 0 and source_country = :sourceCountry and destination_country = :destinationCountry and remainig_balance != :matchingAmount and remainig_balance Between :matchingAmount*0.9 and :matchingAmount*1.1 ", nativeQuery = true)
    List<Offer> findRangeMatchingOffer(@Param("id") long id,@Param("matchingAmount") float matchingAmount,@Param("sourceCountry") String sourceCountry, @Param("destinationCountry") String destinationCountry);

    @Query(value = "Select * from Offer Where user_id != :id and status = 'open' and counter_offer_or_not = 0 and source_country = :sourceCountry and destination_country = :destinationCountry and remainig_balance != :matchingAmount and remainig_balance < :matchingAmount Order By remainig_balance ASC", nativeQuery = true)
    List<Offer> findSplitMatchingOffer(@Param("id") long id,@Param("matchingAmount") float matchingAmount,@Param("sourceCountry") String sourceCountry, @Param("destinationCountry") String destinationCountry);
    ...
    List<Offer> findSameMatchingOffer(@Param("id") long id,@Param("sourceCountry") String sourceCountry, @Param("destinationCountry") String destinationCountry);
    ...
    @Query(value = "Select * from Offer Where user_id != :id and status = 'open' and counter_offer_or_not = 0 and destination_currency = :destinationCurrency and remaining_balance*exchange_rate Between :min and :max", nativeQuery = true)
    ...
    List<Offer> findOfferBySourceCurrencyAmount(@Param("id") long id,
